...
public class ChineseZodiac extends JFrame{
	...
	/*****************************************************
	 * Here we declare a few variables we expect to use throughout
	 * the program. We also check to see if we are allowed to build
	...
	public ChineseZodiac() {
		...
		setBounds(100, 100, 900, 535);
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		
		/*****************************************************
		 * Here we add and set the properties of a JLabel, it is used 
		 * for our output, showing errors or showing your zodiac sign
		 * along with a short text describing it.
		 ****************************************************/
		JLabel zodiacText = new JLabel();
		zodiacText.setBounds(21, 10, 900, 600);
		zodiacText.setFont(new Font("Tahoma", Font.PLAIN, 18));
		
		/*****************************************************
		 * Here we declare and set the properties of a JPanel, 
		 * we use this to prompt the user with our project's objective
		 * and to accept input from the user using attachments.
		 * This JPanel is the basic face to our GUI.
		 ****************************************************/
		...
		/*****************************************************
		 * Here we declare a JTextField which allows the user to 
		 * insert input for our project.
		 ****************************************************/
		...
		/*****************************************************
		 * Here we declare and set the properties of a JButton 
		 * named "submitButton" and this allows the user to 
		 * submit their input.
		 ****************************************************/
		...
		/*****************************************************
		 * Here is where the magic happens, this is where the program
		 * makes the button have a reaction. Once the button is pushed
		 * this part of the program runs. First we set all values of the
		 * JLabel, zodiacText, to null so if the program is run more than
		 * once or the program runs into an error, the fields are cleared.
		 * We then do some error checking making sure that the user's 
		 * input is a valid number and is in bounds to be a valid year.
		 * If the input passes, the method zodiacImage is called and stored
		 * into the JLabel's icon box.
		 ****************************************************/
	 ...
	 * the user's zodiac sign as an image taken from a String array
	 * holding the image directory. The image is specific to the user's
	 * input year.
	 ***************************************/
	public static ImageIcon zodiacImage(int sign) {
		String[] path = {"monkey.png", "rooster.png", "dog.png", "boar.png", "rat.png", "ox.png", "tiger.png", "rabbit.png", "dragon.png", "snake.png", "horse.png", "ram.png"};
